...
sandwitch:list[str] = pan[::] + ingredientes[::] + pan_abajo[::]
print(sandwitch)
...
lista_duplicada: list[int] = lista[::] + lista[::]
...
centro = round((len(lista)/2))
central_element = lista[centro:centro+1]
...
lista = [1, 2, 3, 4, 5, 6]
reverse_list = lista[2::-1] + lista[3:6]
print(reverse_list)